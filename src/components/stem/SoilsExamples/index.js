            ...
            <Grid item container direction="column" className={classes.root} spacing={4} xs={10} md={8} lg={9}>
              ...
              <Grid container item spacing={4}>
                ...
                <Grid container item direction="row" alignItems="flex-end" xs={10}>
                    <Grid item xs={7}>
                      <img className="doc-image" src={soilsexample11} alt="Map of this location" />
                    </Grid>
                    <Grid item xs={5}>
                      <img className="doc-image" src={soilsexample12} alt="Soil profile for this location" />
                    </Grid>
                </Grid>
                <Grid item xs={10}>
                    <img className="doc-image" src={soilsexample13} alt="SCAN station at this location" />
                </Grid>
                <Grid item xs={12}>
                  <Typography align="left" paragraph variant="body1">
              ...
              <Grid container item spacing={4}>
                ...
                <Grid container item direction="row" alignItems="flex-end" xs={10}>
                    <Grid item xs={7}>
                      <img className="doc-image" src={soilsexample21} alt="Map of this location" />
                    </Grid>
                    <Grid item xs={5}>
                      <img className="doc-image" src={soilsexample22} alt="Soil profile for this location" />
                    </Grid>
                </Grid>
                <Grid item xs={10}>
                    <img className="doc-image" src={soilsexample23} alt="SCAN station at this location" />
                </Grid>
                <Grid item xs={12}>
                  <Typography align="left" paragraph variant="body1">
