            ...
            <Grid item container className={classes.root} spacing={4} xs={10} md={8} lg={9}>
              ...
              <Grid item>
                    ...
                    <Typography align="left" paragraph variant="body1">
                      ...
                      <img className="doc-image" src={viewselection} alt="View Selection for the SCAN/TSCAN Livestock Heat Index" /><br/>
                      <img className="doc-image-2" src={userinput} alt="User input for the SCAN/TSCAN Livestock Heat Index" /><br/><br/>
                    </Typography>
                    <Typography align="left" paragraph variant="body1">
                      <i>2. Output</i><br/><br/>
                      ...
                      <img className="doc-image" src={livestockoutput1} alt="Output for the SCAN/TSCAN Livestock Heat Index" /><br/><br/>
                      ...
                      <img className="doc-image" src={livestockoutput2} alt="Output for the SCAN/TSCAN Livestock Heat Index" /><br/><br/>
                    </Typography>
                    <Button variant="outlined" color="primary" onClick={()=>{history.push(url)}}>
                      Livestock Heat Index
                    </Button>
