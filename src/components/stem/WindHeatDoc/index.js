            ...
            <Grid item container direction="column" className={classes.root} spacing={4} xs={10} md={8} lg={9}>
              ...
              <Grid item>
                    ...
                    <Typography align="left" paragraph variant="body1">
                      ...
                      Hourly air temperature, relative humidity, and wind speed are used to calculate the likely amount of heat index and wind chill experienced during each hour. 
                      <br/><br/>
                    </Typography>
                    <Typography align="left" paragraph variant="body1">
              ...
              <Grid item>
                    ...
                    <Typography align="left" paragraph variant="body1">
                      ...
                      <img className="doc-image" style={{ width: '500px', margin: '0 auto' }} src={viewselection} alt="View Selection for the SCAN/TSCAN Wind Chill & Heat Index" /><br/>
                      <img className="doc-image-2" src={userinput} alt="User input for the SCAN/TSCAN Wind Chill & Heat Index" /><br/><br/>
                    </Typography>
                    <Typography align="left" paragraph variant="body1">
                      <i>2. Output</i><br/><br/>
                      ...
                      <img className="doc-image" src={output1} alt="Output for the SCAN/TSCAN Wind Chill & Heat Index" /><br/><br/>
                      ...
                      <img className="doc-image" src={output2} alt="Output for the SCAN/TSCAN Wind Chill & Heat Index" /><br/><br/>
                    </Typography>
                    <Button variant="outlined" color="primary" onClick={()=>{history.push(url)}}>
                      Wind Chill and Heat Index Charts
                    </Button>
