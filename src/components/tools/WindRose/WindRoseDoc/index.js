            ...
            <Grid item container direction="column" className={classes.root} spacing={4} xs={10} md={8} lg={9}>
              ...
              <Grid item>
                    ...
                    <Typography align="left" paragraph variant="body1">
                      ...
                      <img className={classes.docImage} src={userinput1} alt="Sample user input from the SCAN/TSCAN Wind Rose Diagram" /><br/><br/>
                      ...
                      <img className={classes.docImage} src={userinput3} alt="Sample user input from the SCAN/TSCAN Wind Rose Diagram" />
                    ...
                    <Typography align="left" paragraph variant="body1">
                      ...
                      <img className={classes.docImage} src={output1} alt="Sample graphic output of the SCAN/TSCAN Wind Rose Diagram" /><br/>
                      ...
                      <img className={classes.docImage} src={output2} alt="Sample wind frequency table output from the SCAN/TSCAN Wind Rose Diagram" /><br/>
                    </Typography>
              </Grid>
            </Grid>
          </Grid>
