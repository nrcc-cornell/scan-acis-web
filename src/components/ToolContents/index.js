...
import FruitTool from '../../components/tools/Fruit';
              ...
              <div style={{ overflow: 'hidden' }}>
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    ...
                    { this.props.name==='fruit-tool' && app.getLocation && (<FruitTool {...this.props} station={app.getLocation.sid} stnname={app.getLocation.name+', '+app.getLocation.state} stncoords={app.getLocation.ll} por_start={app.getLocation.sdate} outputtype={app.getOutputType}/>) }
                  </Grid>
                </Grid>
              </div>
            </div>
