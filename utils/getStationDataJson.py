...
def getMtdStartString(s): return datetime.datetime.strptime(s,"%Y-%m-%d").strftime("%b")+' 1'
...
dataOut = {
	'date':dateString,
        'ytd_start': 'Jan 1',
	'mtd_start':getMtdStartString(dateString),
	'std_start':getStdStartString(dateString),
	'locs':stnDataOut[-300:],
}
